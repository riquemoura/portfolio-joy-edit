-- Atualizar função RPC para incluir o campo position
...
BEGIN
  ...
  -- Insere produtos com position baseada na ordem do array
  INSERT INTO public.products (id, catalog_id, name, description, price, image_url, position)
  SELECT
